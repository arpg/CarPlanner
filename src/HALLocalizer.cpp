...
HALLocalizer::HALLocalizer()
{
    ...
    LOG(INFO) << "New HALLocalizer created.";
...
{
    LOG(INFO) << "Starting HALLocalizer thread.";

    if( m_bIsStarted == true ) {
        LOG(ERROR) << "HALLocalizer thread already started";
        //throw MochaException("The Localizer thread has already started.");
        return;
    }

    m_pThread = new boost::thread([this] () { HALLocalizer::_ThreadFunction(this); } );
    m_bIsStarted = true;
...
void HALLocalizer::Stop()
{
    ...
    LOG(INFO) << "HALLocalizer thread stopped.";
}
...
//////////////////////////////////////////////////////////////////
//
//Eigen::Matrix<double,6,1> HALLocalizer::GetdPose( const std::string& sObjectName )
//{
//    if( m_mObjects.find( sObjectName ) == m_mObjects.end() ){
//        throw MochaException("Invalid object name.");
//    }
...
//////////////////////////////////////////////////////////////////
eLocType HALLocalizer::WhereAmI( Eigen::Vector3d P )
{
    return VT_AIR;
}

//////////////////////////////////////////////////////////////////
eLocType HALLocalizer::WhereAmI( Eigen::Matrix<double, 6, 1 > P )
{
...
// //////////////////////////////////////////////////////////////////
// void HALLocalizer::_ThreadFunction(Localizer *pV) {
//   while (1) {
...
//////////////////////////////////////////////////////////////////////////////
Sophus::SE3d HALLocalizer::LookupPose(std::string objectName)
{
...
double HALLocalizer::LookupTime()
{
    return posys.device_time();
}