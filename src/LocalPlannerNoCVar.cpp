...
//static bool g_bUseGoalPoseStepping = false;
...
struct ApplyCommandsThreadFunctor {
    ApplyCommandsThreadFunctor(LocalPlannerNoCVar *pPlanner, LocalProblem& problem,const int index , Eigen::Vector6d& poseOut,Eigen::VectorXd& errorOut,
...
LocalPlannerNoCVar::LocalPlannerNoCVar() :
    m_dEps(1e-6),
...
///////////////////////////////////////////////////////////////////////
void LocalPlannerNoCVar::SamplePath(const LocalProblem& problem, Eigen::Vector3dAlignedVec& vSamples, bool bBestSolution /* = true */ )
{
    vSamples.clear();
...
///////////////////////////////////////////////////////////////////////
Eigen::Vector6d LocalPlannerNoCVar::_Transform3dGoalPose(const VehicleState& state, const LocalProblem &problem) const
{
...
///////////////////////////////////////////////////////////////////////
Eigen::Vector6d  LocalPlannerNoCVar::_TransformGoalPose(const Eigen::Vector6d& dGoalPose,const LocalProblem& problem) const
{
...
///////////////////////////////////////////////////////////////////////
Eigen::VectorXd LocalPlannerNoCVar::_GetTrajectoryError(const MotionSample& sample,
...
///////////////////////////////////////////////////////////////////////
Eigen::VectorXd LocalPlannerNoCVar::_GetWeightVector(const LocalProblem& problem)
{
...
///////////////////////////////////////////////////////////////////////
double LocalPlannerNoCVar::_CalculateErrorNorm(const LocalProblem& problem,const Eigen::VectorXd& dError)
{
...
///////////////////////////////////////////////////////////////////////
Eigen::VectorXd LocalPlannerNoCVar::_CalculateSampleError(const MotionSample& sample, LocalProblem& problem, double& dMinTrajTime) const
{
    int errorVecSize = problem.m_eCostMode == eCostPoint ? POINT_COST_ERROR_TERMS : TRAJ_UNIT_ERROR_TERMS*g_nTrajectoryCostSegments+TRAJ_EXTRA_ERROR_TERMS;
...
///////////////////////////////////////////////////////////////////////
bool LocalPlannerNoCVar::_CalculateJacobian(LocalProblem& problem,
...
///////////////////////////////////////////////////////////////////////
double LocalPlannerNoCVar::_DistanceTraveled( const double& t,const AccelerationProfile& profile ) const
{
    double totalDist = 0;
    double lastTime = 0;
...
///////////////////////////////////////////////////////////////////////
void LocalPlannerNoCVar::SampleAcceleration(std::vector<ControlCommand>& vCommands, LocalProblem& problem) const
{
    vCommands.clear();
...
///////////////////////////////////////////////////////////////////////
Eigen::Vector6d LocalPlannerNoCVar::SimulateTrajectory(MotionSample& sample,
...
///////////////////////////////////////////////////////////////////////
void LocalPlannerNoCVar::_GetAccelerationProfile(LocalProblem& problem) const
{
...
///////////////////////////////////////////////////////////////////////
bool LocalPlannerNoCVar::InitializeLocalProblem(LocalProblem& problem,
...
///////////////////////////////////////////////////////////////////////
bool LocalPlannerNoCVar::Iterate(LocalProblem &problem )
{
    try
    {
...
void LocalPlannerNoCVar::CalculateTorqueCoefficients(LocalProblem& problem,MotionSample* pSample)
{
...
void LocalPlannerNoCVar::StressTest(LocalProblem &problem)
{
...
///////////////////////////////////////////////////////////////////////
bool LocalPlannerNoCVar::_IterateGaussNewton( LocalProblem& problem )
{
    Eigen::IOFormat CleanFmt(8, 0, ", ", "\n", "[", "]");
